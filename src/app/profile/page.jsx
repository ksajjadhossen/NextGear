...
const ProfilePage = () => {
  ...
  useEffect(() => {
    // কুকি থেকে রোল নিয়ে আসা
    const userRole = Cookies.get("userRole");
    setRole(userRole || "user");
  }, [user]);

  // ইউজার যদি লগইন না থাকে তবে লগইন পেজে রিডাইরেক্ট করা
  if (!user) {
    return (
  ...
  return (
    <div className="min-h-[85vh] bg-white text-black py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-3xl mx-auto">
        {/* টপ সেকশন হেডার (আপনার ড্যাশবোর্ডের টেক-স্টাইল অনুযায়ী) */}
